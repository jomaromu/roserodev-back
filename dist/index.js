...
// });
mongoose_1.default.connect('mongodb://127.0.0.1:27017/roserodevDB', { useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false, useCreateIndex: true }, (err) => {
    if (err)
        throw err;
    console.log('Base de datos Online');
});
